...
window.onload = function() {
    ...
    if (browserType == "Safari" && device != "desktop") {
        alert("This is what happens when Apple tries. You're on Safari! Gross! Some features of the game are BREAKING because of you! I want to stick it to Apple! Please tell them to fix their damn browser! Some features may not work as intended because of that damn company!");
    }
